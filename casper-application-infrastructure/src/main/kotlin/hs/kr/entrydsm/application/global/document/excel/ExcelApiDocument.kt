...
interface ExcelApiDocument {
    ...
    @Operation(
        summary = "수험표 출력",
        description = "제출된 모든 지원서를 기반으로 수험표 Excel 파일을 생성하여 다운로드합니다. " +
    ...
    @Operation(
        ...
        description = "1차 전형을 통과한 지원자들의 수험번호, 접수번호, 성명이 포함된 " +
    ...
    @Operation(
        summary = "전형자료 출력",
        description = "제출된 모든 지원서의 상세 정보를 포함한 전형자료 Excel 파일을 생성하여 다운로드합니다. " +
    ...
    @Operation(
        summary = "지원서 점검표 출력",
        description = "제출된 모든 지원서의 점검용 Excel 파일을 생성하여 다운로드합니다. " +
