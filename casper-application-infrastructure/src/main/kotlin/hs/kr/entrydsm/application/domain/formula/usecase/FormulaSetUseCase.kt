...
class FormulaSetUseCase(
    ...
    fun createFormulaSet(request: CreateFormulaSetRequest): FormulaSetResponse {
        val formulaSteps = request.formulas.map { step ->
            mapOf(
                "step" to step.step,
                "name" to step.name,
        ...
        return FormulaSetResponse(
            success = true,
            data = FormulaSetResponse.FormulaSetData(
    ...
    fun updateFormulaSet(formulaSetId: String, request: UpdateFormulaSetRequest): FormulaSetResponse {
        val uuid = UUID.fromString(formulaSetId)
        val entity = formulaSetRepository.findById(uuid)
        ...
        val updatedEntity = FormulaSetJpaEntity(
    ...
    fun getFormulaSetList(): FormulaSetListResponse {
        ...
        return FormulaSetListResponse(
            success = true,
            data = FormulaSetListResponse.FormulaSetListData(
                formulaSets = entities.map { entity ->
    ...
    fun getFormulaSetDetail(formulaSetId: String): FormulaSetDetailResponse {
        ...
        return FormulaSetDetailResponse(
            success = true,
            data = FormulaSetDetailResponse.FormulaSetDetailData(
                formulaSetId = entity.formulaSetId.toString(),
                name = entity.name,
    ...
    fun deleteFormulaSet(formulaSetId: String) {
        ...
        val archivedEntity = FormulaSetJpaEntity(
            formulaSetId = entity.formulaSetId,
            name = entity.name,
            description = entity.description,
            applicationType = entity.applicationType,
    ...
    fun executeFormulas(formulaSetId: String, request: FormulaExecutionRequest): FormulaExecutionResponse {
        val uuid = UUID.fromString(formulaSetId)
        val entity = formulaSetRepository.findById(uuid)
            .orElseThrow { IllegalArgumentException("수식 집합을 찾을 수 없습니다: $formulaSetId") }
        ...
        try {
            ...
            return FormulaExecutionResponse(
                success = true,
                data = FormulaExecutionResponse.ExecutionData(
