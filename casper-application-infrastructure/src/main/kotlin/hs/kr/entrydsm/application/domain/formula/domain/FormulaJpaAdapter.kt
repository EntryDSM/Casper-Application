...
class FormulaJpaAdapter(
    ...
    override fun findById(id: FormulaSetId): FormulaSet? {
        val entity =
            formulaSetRepository.findById(UUID.fromString(id.value))
    ...
    override fun findExecutionById(id: FormulaExecutionId): FormulaExecution? {
        val entity =
            formulaExecutionRepository.findById(UUID.fromString(id.value))
                .orElse(null) ?: return null
    ...
    override fun findExecutionsByFormulaSetId(formulaSetId: FormulaSetId): List<FormulaExecution> {
        val entities =
            formulaExecutionRepository.findAllByFormulaSetIdOrderByExecutedAtDesc(
    ...
    override fun findByApplicationCriteria(
        ...
        val entity =
            formulaSetRepository.findByApplicationCriteria(
    ...
    private fun mapToDomain(entity: FormulaSetJpaEntity): FormulaSet {
        val formulasList: List<Map<String, Any>> =
            try {
    ...
    private fun mapExecutionToDomain(entity: FormulaExecutionJpaEntity): FormulaExecution {
        val executionStepsList: List<Map<String, Any>> =
            try {
        ...
        val executionSteps =
            executionStepsList.map { stepMap ->
                ExecutionStep(
