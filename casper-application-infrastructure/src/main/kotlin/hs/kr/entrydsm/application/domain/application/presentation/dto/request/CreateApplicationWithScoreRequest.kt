...
/**
 * 원서 작성과 성적 입력을 통합한 요청 DTO
 */
data class CreateApplicationWithScoreRequest(
    // 원서 정보
    ...
    val applicationRemark: String, // "NOTHING", "ONE_PARENT", etc.
    ...
    fun toApplicationCommand(userId: UUID): CreateApplicationCommand {
    ...
    fun toScoreCommand(userId: UUID): CreateScoreCommand {
