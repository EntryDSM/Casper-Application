...
class ApplicationSubmissionController(
    ...
    private fun createErrorResponse(message: String, status: HttpStatus): ResponseEntity<ApplicationSubmissionResponse> {
        val errorResponse = ApplicationSubmissionResponse(
            success = false,
