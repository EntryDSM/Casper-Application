...
class PdfDataConverter {
    ...
    fun applicationToInfo(application: Any, score: Any): PdfData {
    ...
    private fun setVeteransNumber(application: Any, values: MutableMap<String, Any>) {
        // TODO: Application 도메인 모델 연동 필요
    ...
    private fun setAttendanceAndVolunteer(application: Any, values: MutableMap<String, Any>) {
    ...
    private fun setGenderInfo(application: Any, values: MutableMap<String, Any>) {
    ...
    private fun setGraduationClassification(application: Any, values: MutableMap<String, Any>) {
    ...
    private fun setUserType(application: Any, values: MutableMap<String, Any>) {
        val list = listOf(
    ...
    private fun setExtraScore(application: Any, values: MutableMap<String, Any>) {
    ...
    private fun setGradeScore(application: Any, score: Any, values: MutableMap<String, Any>) {
    ...
    private fun setAllSubjectScores(application: Any, values: MutableMap<String, Any>) {
    ...
    private fun setTeacherInfo(application: Any, values: MutableMap<String, Any>) {
        // TODO: 졸업정보 연동 필요
        values["teacherName"] = "더미선생님"
        values["teacherTel"] = toFormattedPhoneNumber("0421234567")
    }

    private fun setParentInfo(application: Any, values: MutableMap<String, Any>) {
        values["parentName"] = "더미학부모"
        values["parentRelation"] = "부"
    }

    private fun setRecommendations(application: Any, values: MutableMap<String, Any>) {
    ...
    private fun setBase64Image(application: Any, values: MutableMap<String, Any>) {
        // TODO: 이미지 파일 연동 필요
        values["base64Image"] = ""
    }
